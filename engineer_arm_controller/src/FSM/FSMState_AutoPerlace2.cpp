#include "FSM/FSMState_AutoPerlace2.hpp"

using namespace std::chrono_literals;

/* 创建状态类 */
FSMState_AutoPerlace2::FSMState_AutoPerlace2():
                  FSMState(FSMStateName::AUTO_PERLACE_2, "auto_perlace_2"){}

/* 创建 rosbag 读取指针 */
// rosbag2_storage::StorageOptions storage_options(
//     {"/home/engineer/engineer_ws/src/Engineer_ROS2_controller/engineer_bag/auto_perlace_2_1/auto_perlace_2_1_0.db3",
//      "sqlite3"});
...
void FSMState_AutoPerlace2::enter()
{
    /* 初始化 rosbag 读取指针 */
    rosbag2_storage::StorageOptions storage_options(
        {"/home/engineer/engineer_ws/src/Engineer_ROS2_controller/engineer_bag/auto_perlace_2_1/auto_perlace_2_1_0.db3",
...
void FSMState_AutoPerlace2::run()
{
    engineer_msg::msg::LiftState lift_state;
    engineer_msg::msg::SucketState sucket_state;

    if ((this->BagPlay_Counter < 490) && (lift_position_real < 250))
    {
        lift_state.rise = true;
        lift_state.fall = false;
    }
    else if ((this->BagPlay_Counter >= 490) && (this->BagPlay_Counter < 500) && (lift_position_real > 140))
    {
