...
#define PACK_STATE_WAIT 0
#define PACK_STATE_GETSTART 	1
#define PACK_STATE_GET 	2
#define PACK_STATE_GETFINISH	3


#define MODE_CHASSIS	0x11
#define MODE_GIMBAL		0x21
